...
public class GMActivity extends Activity implements LocationListener, AdapterView.OnItemClickListener {
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        intent.setClass(GMActivity.this, MapsStore.class);
        if(parent==listView1) {
    ...
    private class HttpAsyncTask extends AsyncTask<String, Void, String>
    {
        ...
        protected void onPostExecute(String result) {
            try{
                ...
                SimpleAdapter adapter1 = new SimpleAdapter(GMActivity.this, list1, R.layout.store_list, from, to);
                SimpleAdapter adapter2 = new SimpleAdapter(GMActivity.this, list2, R.layout.store_list, from, to);
                ...
                listView1.setOnItemClickListener(GMActivity.this);
                listView2.setOnItemClickListener(GMActivity.this);
