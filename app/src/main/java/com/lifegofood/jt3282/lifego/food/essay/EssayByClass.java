...
/**
 * Created by jt3282 on 2017/12/22.
 */

public class EssayByClass extends Activity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private class RunTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            if(classes.equals("all"))result = DownloadImg.executeQuery(UPLOAD_URL,"SELECT * FROM upload_img NATURAL JOIN upload_info WHERE 1 ORDER BY post_time DESC");
            else result = DownloadImg.executeQuery(UPLOAD_URL,"SELECT * FROM upload_img NATURAL JOIN upload_info WHERE class='"+classes+"' ORDER BY post_time DESC");
                        ...
                        public void run() {
                            ...
                            if(num>0){
                               // listView.setOnScrollListener(new PauseOnScrollListener(imageLoader, false, true));
                                ...
                                n = new RecyclerItemClickListener(EssayByClass.this, new RecyclerItemClickListener.OnItemClickListener() {
                                    @Override public void onItemClick(View view, int position) {
                                        Intent intent = new Intent();
                                        intent.setClass(EssayByClass.this, EssayFrame.class);
                                ...
                                listView.setLayoutManager(new LinearLayoutManager(EssayByClass.this));
                                ...
                                Toast.makeText(EssayByClass.this, "沒有更多文章", Toast.LENGTH_SHORT).show();
                            }
                            loading.setVisibility(View.GONE);
                        }
                    });
