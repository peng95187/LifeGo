...
public class Bus_sts_result extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bus_sts_result);

        recyclerView = (RecyclerView) findViewById(R.id.bsr_rv);

        String county = getIntent().getStringExtra("location");
        String start = Uri.encode(getIntent().getStringExtra("start"));
        String end = Uri.encode(getIntent().getStringExtra("end"));

        href = "http://ptx.transportdata.tw/MOTC/v2/Bus/StopOfRoute/City/"+county+"?$select=RouteName" +
            ...
            try{
                ...
                if (length != 0) {
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(Bus_sts_result.this, "查無資訊", Toast.LENGTH_SHORT).show();
                        }
                    });
                }
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        recyclerView.addItemDecoration(new DividerItemDecoration(Bus_sts_result.this, DividerItemDecoration.VERTICAL));
                        recyclerView.setLayoutManager(new LinearLayoutManager(Bus_sts_result.this));
                    }
                });
                ...
                e.printStackTrace();
                Toast.makeText(Bus_sts_result.this, "無法取得資料", Toast.LENGTH_SHORT).show();
            }
        }
    ...
    public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder>{
        ...
        public MyAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.bsr_rv,parent,false);
        ...
        public void onBindViewHolder(MyAdapter.ViewHolder holder, final int position) {
            ...
            holder.route.setText(list.get(position).get("route"));
