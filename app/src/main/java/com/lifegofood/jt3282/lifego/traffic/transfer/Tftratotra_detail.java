...
public class Tftratotra_detail extends Activity {

    String href1 = "",date = "",time = "",start = "",mid = "",end = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tftratotra_detail);
                    ...
                    try {
                        ...
                        if(length!=0){
                            for(int i = 0;i < jObject.getJSONArray("results").length();i++) {
                                ...
                                String tra_result = TrafficHttpRequest.getData("http://ptx.transportdata.tw/MOTC/v2/Rail/TRA/DailyTimetable/OD/"+mid+"/to/"+end+"/"+date+"?$filter=OriginStopTime%2FDepartureTime%20ge%20'"
                                ...
                                if(jObject2.getJSONArray("results").length()!=0){
                                    String tra_id = "",tra_des = "",tra_arr = "",tra_type = "";
                                    ...
                                    runOnUiThread(new Runnable() {
                                        @Override
                                        public void run() {
                                            Toast.makeText(Tftratotra_detail.this, "查無相關車次", Toast.LENGTH_SHORT).show();
                                        }
                                    });
                                }
                            }
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                if(length==0){
                                    ...
                                    recyclerView.addItemDecoration(new DividerItemDecoration(Tftratotra_detail.this, DividerItemDecoration.VERTICAL));
                                    recyclerView.setLayoutManager(new LinearLayoutManager(Tftratotra_detail.this));
                                }
                            }
                        });
                    } catch (JSONException e) {
                        Toast.makeText(Tftratotra_detail.this, "無法取得資訊", Toast.LENGTH_SHORT).show();
                        e.printStackTrace();
                    }
                }
            }).start();
    ...
    public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder>{
        ...
        public MyAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.tr_rv,parent,false);
        ...
        public class ViewHolder extends RecyclerView.ViewHolder {
            public TextView type1,type2,id,des,arr,trans,tra_id,tra_des,tra_arr;
